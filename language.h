...
const char SETUP_READY[] PROGMEM = "Ready..";

// ===== SERIAL COMMAND LINE INTERFACE ===== //
const char CLI_EVILTWIN[] PROGMEM = "eviltwin";
const char CLI_WELCOME[] PROGMEM = "welcome";
const char CLI_ROGUE[] PROGMEM = "rogueap";
...
const char CLI_CHICKEN[] PROGMEM = "wifix,x";                  // chicken, chickens
...
const char D_NAME[] PROGMEM = "ADD NAME";
...
const char D_PROBE_MONITOR[] PROGMEM = "PROBE MONITOR";
const char D_EVIL_DETECTOR[] PROGMEM = "EVIL TWIN SCANNER";
const char D_AP_OFF[] PROGMEM = "AP OFF";
const char D_AP_ON[] PROGMEM = "AP ON";
...
const char D_SCAN_ST_1[] PROGMEM = "SCAN Stations 60s";
...
const char D_EVIL[] PROGMEM = "E-TWIN";
const char D_ROGUE[] PROGMEM = "ROGUE_AP";
...
// DEAUTH ALL SCREEN
const char D_DEAUTH_ALL_1[] PROGMEM = "Attacking:";
const char D_DEAUTH_ALL_2[] PROGMEM = "Scanning...";
const char D_DEAUTH_ALL_3[] PROGMEM = "Scan paused";

// PROBE MONITOR SCREEN
const char D_PROBE_1[] PROGMEM = "Probes:";
